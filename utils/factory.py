...
from models.der_twodataloader import DER_twodataloader
from models.ewc import EWC
from models.finetune import Finetune
from models.foster import FOSTER
from models.gem import GEM
from models.icarl import iCaRL
from models.icarl_twodataloader import iCaRL_twodataloader
...
def get_model(model_name, args):
    ...
    if name == "icarl":
        return iCaRL(args)
    elif name == "icarl_twodataloader":
        return iCaRL_twodataloader(args)
    elif name == "bic":
        return BiC(args)
    elif name == "podnet":
        return PODNet(args)
        ...
        return DER(args)
    elif name == "der_twodataloader":
        return DER_twodataloader(args)
    elif name == "finetune":
